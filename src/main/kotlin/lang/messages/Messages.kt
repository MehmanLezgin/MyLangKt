...
object Messages {
    const val F_MODULE_DOES_NOT_EXPORT_SYM = "A module '%s' does not export '%s'"
    ...
    const val MODULE_NOT_DEFINED = "Module not defined"
    ...
    const val F_NO_BIN_OPER_FUNC_OVERLOAD = "Operator '%s' not defined for '%s' and '%s'"
    ...
    const val F_SYMBOL_NOT_DEFINED_CUR = "A symbol '%s' not defined in current scope"
    const val F_SYMBOL_NOT_DEFINED_IN = "A symbol '%s' not defined in '%s'"
    const val F_FUNC_NOT_DEFINED = "A function '%s' not defined in current scope"
