...
object Messages {
    const val NONE_OF_N_OVERLOADS_APPLICABLE_FOR_TYPE = "None of the %d overloads are applicable for type '%s'"
    ...
    const val CANNOT_CAST_TYPE = "Cannot cast type '%s' to '%s'"
    const val NO_BIN_OPER_FUNC_OVERLOAD = "Operator '%s' is not defined for '%s' and '%s'"
    const val ERROR_TYPE = "[ Error ]"
    const val CONST = "const"
    const val TYPE_MISMATCH = "Type mismatch: expected '%s', actual '%s'"
