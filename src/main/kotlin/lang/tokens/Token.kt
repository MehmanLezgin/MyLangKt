...
//    data class Comma(override val raw: String, override val pos: SymbolPos) : Token(raw, pos)
    ...
    data class Str(val value: String, override val raw: String, override val pos: Pos) : Token(raw, pos)
    data class Character(val value: Char, override val raw: String, override val pos: Pos) : Token(raw, pos)
